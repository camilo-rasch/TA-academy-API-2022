...
public class BankTransaction {
    ...
    /**
     * Constructor with no id attribute.
     * This constructor should be use when the endpoint has autogenerated ids.
     ...
     */
    public BankTransaction(String name, String lastName, String accountNumber, double amount,
